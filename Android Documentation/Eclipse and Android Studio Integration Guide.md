...
![Eclipse]
(https://code.oovoo.com/native/docs/android/eclipse/1.png)
...
(https://code.oovoo.com/native/docs/android/eclipse/2.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/3.png)

**Step #4**

Open your project properties select *Java Build Path* and *Libraries* and add the *oovoosdk.jar* from your libs folder in order to link it.

![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/4.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/5.png)

**Step #6**

Register MyApplication class in AndroidManifest.xml

![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/6.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/7.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/eclipse/8.png)
...
Create a new project, choose *Start New Android Studio Project*

![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/1.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/2.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/3.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/4.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/5.png)

**Step #6**

Build a new Java Class.

Right click on package name, choose *New -> Java Class* , and *extends Application* class.
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/6.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/7.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/8.png)
...
![enter image description here]
(https://code.oovoo.com/native/docs/android/androidstudio/9.png)
